            ...
            <Card style={card}>
                ...
                <Form form={form} onFinish={onFinish}>
                    <Row>
                        ...
                        <Col span={24}>
                            <Form.Item name="role" rules={[{ required: true, message: t("role_required") }]}>
                                <Select style={inputFieldStyle } placeholder={t("role_placeholder")}>
                                    <Select.Option value="2" style={{ fontSize: "16px" }}>{t("teacher")}</Select.Option>
                                    <Select.Option value="1" style={{ fontSize: "16px" }}>{t("student")}</Select.Option>
                                </Select>
                            </Form.Item>
                        </Col>   
                        <Col span={24}>
